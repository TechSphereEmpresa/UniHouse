...
const ctxTarefasConcluidas = document.getElementById("graficoTarefasConcluidas").getContext("2d");
...
const ctxTarefasAtrasadas = document.getElementById("graficoTarefasAtrasadas").getContext("2d");
const graficoTarefasAtrasadas = new Chart(ctxTarefasAtrasadas, {
    ...
    data: {
        ...
        datasets: [{
            label: "[Nome]",
            data: [1, 2, 1, 2, 1],
            backgroundColor: ["#264370", "#F4A503", "#3C755A", "#F56602", "#9747FF"],
